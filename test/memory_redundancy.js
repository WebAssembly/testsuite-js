...
function testModule0() {
  var module = createModule([
    ...
    116,  95, 114, 101, 116, 117, 114, 110,  95,  52,   4,  99, 111, 100, 101, 149,
      1,   9,  29,   0,  16,   0,  16,   0,  51,   2,   0,  16,   4,  16,   0,  51,
      2,   0,  16,   8,  16,   0,  51,   2,   0,  16,  12,  16,   0,  51,   2,   0,
     23,   0,  16,   8,  16,   0,  51,   2,   0,  16,   5,  19,   0,   0,   0, 128,
     53,   2,   0,  16,   8,  42,   2,   0,  21,   0,  16,   8,  42,   2,   0,  16,
      5,  19,   0,   0,   0, 128,  53,   2,   0,  16,   8,  42,   2,   0,  30,   1,
      1,   3,  16,   8,  16, 163, 198, 140, 153,   2,  51,   2,   0,  16,  11,  44,
      2,   0,  21,   0,  16,   8,  16,   0,  51,   2,   0,  20,   0,   8,   0,  22,
      0,   1,  16, 128,   1,  77,   4,   0,  22,   0,   0,   8,   0,  22,   0,   2,
     16, 128,   1,  77,   4,   0,  22,   0,   0,  12,   0,  22,   0,   3, 180,  19,
     35,   0,   0,   0, 180,  77,
  ]);

  assertReturn(module, '$assert_return_0', 'external/testsuite/memory_redundancy.wast', 40);
  invoke(module, '$invoke_1');
  assertReturn(module, '$assert_return_2', 'external/testsuite/memory_redundancy.wast', 42);
  invoke(module, '$invoke_3');
  assertReturn(module, '$assert_return_4', 'external/testsuite/memory_redundancy.wast', 44);
}
